...
- Sempre mencione, resumidamente, o que ESTÁ disponível hoje:
  consultas de faturamento (mensal e diário), de metas e de NPS, por
  filial, RCA, supervisor e período, além da lista de filiais.
...

{
    ...
    "ferramenta": null,
    "argumentos": {},
    "mensagem": "No momento só consigo ajudar com consultas de faturamento (mensal e diário), metas e NPS, por filial, RCA, supervisor ou período. Previsão do tempo não está disponível — mas posso ajudar com algum indicador comercial?"
}
